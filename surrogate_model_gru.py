...
from utils.lploss import *
import utils.normalizer_gru 
# from utils import fno_3d_LKA
from fno_3d_LKA_test import FNO3d


class SurrogateModel:
    def __init__(self, model_path, model_type, device=None, input_file="inference_input.h5", normalizer_path=None, num_channel=5):
        """
    ...
    def load_model(self, model_path):
        ...
        if self.model_type == "sat":
            model = FNO3d(modes[0], modes[1], modes[2], width, input_channel=self.num_channel, num_cell=4, skip=False)
    ...
    def normalizer(self, normalizer_path):
        ...
        """
        import sys
        sys.modules['utils.normalizer'] = utils.normalizer_gru
